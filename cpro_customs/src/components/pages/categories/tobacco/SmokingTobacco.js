...
class SmokingTobacco extends Component {
    ...
    drawItems = (globalState) => {
        let options = [
            {unit: "grams", type: "Smoking tobacco", value: 250, isOtherAmount: false, icon: "weight"},
            {unit: "grams", type: "Smoking tobacco", value: 50, isOtherAmount: false, icon: "weight"},
            {unit: "grams", type: "Smoking tobacco", value: '', isOtherAmount: true, icon: "weight"},
        ];
        let items = [];
